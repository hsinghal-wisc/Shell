...
fprintf(stdout,"%s\n",cmd3);
fflush(stdout);
//char cc[600]="(()?)";
if(strlen(cmd)>512)
...
if(cmd2[k-1]=='&')
{for(i=0;i<k-2;i++)
ch[map[rc]][i]=cmd2[i];if(cmd2[k-2]!=' ') ch[map[rc]][i]=cmd2[i];}
else
{for(i=0;i<k;i++)
ch[map[rc]][i]=cmd2[i];if(cmd2[k-2]!=' ') ch[map[rc]][i]=cmd2[i];}
...
//char cc[600]="(()?)";
if(strlen(cmd)>512)
{fprintf(stdout,"%s\n",cmd);fflush(stdout);fprintf(stderr,"An error has occurred\n");fflush(stderr);continue;}
